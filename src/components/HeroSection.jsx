...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
       ...
       <p className='max-w-md text-gray-300'> A group of unlikely heroes joins forces to protect the galaxy from a powerful threat,
  turning their journey into an unforgettable cosmic adventure.</p>
