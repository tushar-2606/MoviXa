      ...
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <div className="flex items-center flex-wrap gap-4 mt-4">
            ...
            <a href="#dateSelect" className="px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-mf font-medium cursor-pointer active:scale-95">Buy Tickets</a>
